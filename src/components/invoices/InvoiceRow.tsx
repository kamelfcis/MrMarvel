...
function CustomerMobileCell({ mobile }: { mobile: string | null | undefined }) {
  if (!mobile) return <>—</>
    ...
    <span className="inline-flex items-center justify-center gap-1.5">
      ...
      {waUrl && (
        <a
          ...
          className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-green-600/90 transition hover:bg-green-50 hover:text-green-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-gray-600">
                ...
                <span dir="ltr" className="inline-flex items-center gap-1 text-center">
                  موبيل العميل: <CustomerMobileCell mobile={invoice.customer_mobile} />
                </span>
